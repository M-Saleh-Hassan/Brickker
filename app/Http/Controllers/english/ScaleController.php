...
class ScaleController extends Controller
{
    public function index()
    {
        ...
        return view('tashtebk.english.scale.index')
        ->with('scales', $scales);
    }
    ...
    public function steps($username_tag, $scale_title, $identifier)
    {
        ...
        if(empty($scale)) return redirect()->route('en.home.index');
        $subscription = Subscription::where('identifier', $identifier)->first();
        $categories = Category::where('parent_id', NULL)->get();
        
        return view('tashtebk.english.scale.steps')
        ->with('scale', $scale)
    ...
    public function getSteps(Request $request, $username_tag)
    {
        ...
        $project_modal = view('tashtebk.english.scale.project_modal')
    ...
    public function getOfferModal(Request $request)
    {
        ...
        $modal = view('tashtebk.english.scale.offer_modal')
    ...
    public function makeOffer(Request $request)
    {
        ...
        $offer_row = view('tashtebk.english.scale.offer_data_row')
        ->with('offer', $offer)
        ->render();
        
        $boq_updated_modal = view('tashtebk.english.scale.boq_modal_details')
        ->with('subscription',$subscription)
        ->render();
