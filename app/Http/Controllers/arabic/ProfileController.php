...
class ProfileController extends Controller
{
    public function index()
    {
        ...
        if(Auth::user()->getUserType() == 'customer') return view('tashtebk.arabic.user.profile.customer')->with('active', 'profile');

        return view('tashtebk.arabic.user.profile.index')
    ...
    public function show($username_tag)
    {
        ...
        return view('tashtebk.arabic.user.profile.show')
        ->with('user', $user);
    }
    ...
    public function update(Request $request, $username_tag)
    {
        ...
        return redirect()->route('ar.profile.index', ['username_tag' => $user->username_tag])->with('success', 'تم تعديل الملف الشخصي بنجاح');
    }
    ...
    public function settype(Request $request, $username_tag)
    {
        ...
        $user->save();
        return response()->json(array('redirect' => route('ar.profile.index', [$username_tag])), 200);
    }
    ...
    public function changeType(Request $request)
    {
        ...
        return response()->json(array('redirect' => route('ar.profile.index', [Auth::user()->username_tag])), 200);
    }
    ...
    public function deactivate()
    {
        ...
        Auth::logout();
        return response()->json(array('redirect' => route('ar.home.index')), 200);
    ...
    public function filter(Request $request)
    {
        ...
        $profile_html = view('tashtebk.arabic.user.filter_profiles')
        ->with('user_types',$user_types)
        ->render();
