...
class ProductController extends Controller
{
    public function index($title_tag)
    {
        ...
        {
            $orders_tbody .= view('tashtebk.arabic.checkout.checkout_row')
            ->with('order', $order)
            ->render();
        }
       
        
        return view('tashtebk.arabic.product.index')
    ...
    public function save(Request $request, $username_tag)
    {
        ...
        return redirect()->route('ar.profile.index', ['username_tag' => $user->username_tag])
        ->with('success', 'تمت اضافة المنتج بنجاح')
    ...
    public function filterMainQuantity(Request $request, $username_tag)
    {
        ...
        $products = view('tashtebk.arabic.product.layouts.ajax_main_products')
    ...
    public function chooseMainQuantity(Request $request, $username_tag)
    {
        ...
        $main_product = view('tashtebk.arabic.product.layouts.single_product_selected')
        ->with('product', $product)
        ->render();
    ...
    public function selectedMainQuantity(Request $request, $username_tag)
    {
        ...
        $selected_main_products = view('tashtebk.arabic.product.layouts.selected_main_products')
    ...
    public function allMainQuantity(Request $request, $username_tag)
    {
        ...
        $all_products = view('tashtebk.arabic.product.layouts.ajax_main_products')
    ...
    public function filterSubQuantity(Request $request, $username_tag)
    {
        ...
        $products = view('tashtebk.arabic.product.layouts.ajax_sub_products')
        ->with('products', $products)
    ...
    public function selectedSubQuantity(Request $request, $username_tag)
    {
        ...
        $selected_sub_products = view('tashtebk.arabic.product.layouts.selected_sub_products')
    ...
    public function allSubQuantity(Request $request, $username_tag)
    {
        ...
        $all_products = view('tashtebk.arabic.product.layouts.ajax_sub_products')
        ->with('products', $all_products)
        ->with('sub_product_ids', $sub_product_ids_array)
        ->with('current_quantities', $current_quantities)
        ->render();
