...
class CategoryController extends Controller
{
    ...
    {
        return view('tashtebk.arabic.category.index');
    }
    ...
    public function getProducts($title_tag)
    {
        ...
        return view('tashtebk.arabic.category.subcategory')
    ...
    public function getAllProducts($title_tag)
    {
        ...
        return view('tashtebk.arabic.category.category_products')
    ...
    public function getAllProductsCategories(Request $request)
    {
        ...
        return view('tashtebk.arabic.category.all')
        ->with('products', $products)
    ...
    public function filterProducts(Request $request)
    {
        ...
        if(!empty($categories_filter_ids)):
            ...
            if($user_type->hasFilteredProducts($categories_filter_ids, $low_price, $high_price)):
                ...
                $content .= '                 			<p class="product__price-tag-price">' . $product->current_price . $active_currency->title_ar . '</p>';
                $content .= '                     	</div>';
                                                	endif;
                ...
                $content .= '                                ">'.$product->price.$active_currency->title_ar.'</span>';
                $content .= '                            </div>';
                $content .= '                        </div>';
                $content .= '                    </div>';
                $content .= '                  </div>';
