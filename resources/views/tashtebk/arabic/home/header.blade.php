    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
         ...
         <div class="button-center">
           @if(Auth::check())
               <a href="{{route('ar.about.index')}}" class="btn-home box-shadow margin-top">لنبدأ</a>
           @else
               <a type="button" data-toggle="modal" data-target="#Login-Modal" class="btn-home box-shadow margin-top">لنبدأ</a>
           @endif
           
           @if(!Auth::check())
               <a href="{{route('ar.about.index')}}" class="btn-home box-shadow tr-bg">المزيد</a>
           @endif
        </div>
