                                ...
                                <div class="swiper-slide item scale-item">
                                     <div class="overlay-product">
                                            <div class="elements">
                                                ...
                                                <a href="{{route('ar.profile.show', [$user->username_tag])}}" class="success" title="view" target="_blank"><i class="fa fa-eye"></i></a>
                                            </div>
                                        </div>
...
@section('custom-js')
    ...
    function initializeSelect2(){
        ...
        $('.scale-providers').on('click', '.scale-provider-user, .add-step-product', function(){
            ...
            $.ajax({
                url:"{{ route('ar.scale.step.provider.products') }}",
                method:"POST",
        ...
        $('.step-product-result').on('click', '.add-step-product', function(){
            ...
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url:"{{ route('ar.scale.offer.modal') }}",
                method:"POST",
        ...
        $('.modal').on('click', '.delete-offer', function(){
            if(confirm('Are you sure you want to Delete ?'))
            {
                ...
                $.ajax({
                    url:"{{ route('ar.scale.offer.delete') }}",
                    method:"POST",
