                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><span class="total">{{$active_currency->title_en}} {{ $order->total_price }}</span></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table">
                                        ...
                                        @foreach(Auth::user()->subscriptions as $subscription)
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="{{route('en.scale.steps', [Auth::user()->username_tag, $subscription->scale->title, $subscription->identifier])}}" class="fa fa-eye" title="Show"></a></td>
...
@section('custom-js')
    ...
    $('#subscriptions').on('click', '.delete-subscription', function(){
        if(confirm('Are you sure you want to Delete ?'))
        {
            ...
            $.ajax({
                url:"{{ route('en.checkout.subscription.delete') }}",
                method:"POST",
