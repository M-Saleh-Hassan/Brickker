            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="profile-info box text-center">
                        ...
                        <button class="btn btn-home chat-control"> <i class='fa fa-comment'></i> Chat</button>
                    </div>
                    <div class="box-about box">
                        <h4>About Me</h4>
                        <div class="item">
                            <h5><div class="fa fa-map-marker"></div> Location</h5>
                            <p>{{$user->country->title_en}}</p>
                                    ...
                                    @foreach ($user->products as $product)
                                        <div class="col-md-3">
                                            <div class="p-item relate-item">
                                                <div class="img-item">
                                                    <a href="{{route('en.product.index', ['title_tag'=>$product->title_tag])}}" target="_blank">
            ...
            <div class="chat-window col-xs-9 col-sm-4 col-md-3 hidden"  id="chat_window_1">
                <div class="panel panel-default" >
                    ...
                    <div class="panel-heading top-bar" >
                        ...
                        @else
                        <a href="#" class="text-right" type="button" data-toggle="modal" data-target="#Login-Modal"><span id="minim_chat_window" class="glyphicon glyphicon-minus icon_minim"></span></a>
                        @endif
                    </div>
                    ...
                    <div class="panel-body msg_container_base">
                        ...
                        <div class="type_msg">
                            <div class="input_msg_write">
                                <form class="form-horizontal" method="POST" action="{{ route('en.chat.send') }}" enctype="multipart/form-data">
                                    @csrf
