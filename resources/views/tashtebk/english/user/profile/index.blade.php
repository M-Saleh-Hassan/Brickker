    ...
    <section class="gray section">
        <div class="container">
                ...
                <div class="col-md-3">
                    ...
                    <div class="box-about box">
                        ...
                        <div class="item">
                            ...
                            <p>{{Auth::user()->phone}}</p>
                            <h5><div class="fa fa-briefcase"></div> Work</h5>
                            <p>{{ucfirst(Auth::user()->getUserType())}}</p>
                            <h5><div class="fa fa-building"></div> Company</h5>
                            <p>{{Auth::user()->company_name}}</p>
                        </div>
                        <div class="item">
                            <h5><div class="fa fa-pencil"></div> Categories</h5>
                            <?php $i=0; ?>
                ...
                <div class="col-md-9">
                    <div class="box-tabs">
                        <ul class="nav nav-tabs">
                            ...
                            <li @if(session('active') == 'add_products'   || $active == 'add_products') class="active"   @endif><a data-toggle="tab" href="#menu1">Add {{Auth::user()->getProductOrServiceType()}}</a></li>
                            <li @if(session('active') == 'my_products'    || $active == 'my_products') class="active"    @endif><a data-toggle="tab" href="#menu2">My {{Auth::user()->getProductOrServiceType()}}s</a></li>
                            @if(Auth::user()->getUserType() == 'consultant')
                            <li @if(session('active') == 'add_quantities' || $active == 'add_quantities') class="active" @endif><a data-toggle="tab" href="#menu3">Add Quantities</a></li>
                                    ...
                                    @foreach (Auth::user()->products as $product)
                                        <div class="col-md-3">
                                        		...
                                        		<div class="modal-dialog extend-modal-width" role="document">
                                        		  <div class="modal-content" >
                                        			...
                                        			<div class="modal-body">
                                        				<form class="product-edit-form" method="POST" action="{{ route('en.profile.product.update', ['username_tag' => Auth::user()->username_tag, 'product_id' => $product->id]) }}" enctype="multipart/form-data">
                                        					@csrf
                                                                        ...
                                                                        <div class="p-item relate-item">
                                                                            ...
                                                                            <div class="overlay-product">
                                                                                <div class="elements">
                                                                                    ...
                                                                                    <a href="{{ route('en.product.index', ['title_tag'=>$current->childProduct->title_tag])}}" class="success" title="view" target="_blank"><i class="fa fa-eye"></i></a>
                                                                            ...
                                                                            <div class="p-info">
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <a href="{{route('en.product.index', ['title_tag'=>$current->childProduct->title_tag])}}"><i class="fa fa-shopping-cart"></i></a>
                                            ...
                                            <div class="p-item relate-item">
                                                <div class="overlay-product">
                                                    <div class="elements">
                                                        <a href="{{route('en.profile.product.delete',[Auth::user()->username_tag, $product->id])}}" class="danger" title="Delete" onclick="return confirm('Are you sure you want to Delete ?');" ><i class="fa fa-close"></i></a>
            ...
            <div class="row user_type_select text-center ">
                ...
                <h2 class="title-p">Complete your profile</h2>
...
@section('custom-js')
    ...
    $( "select[name='main_product_category']" ).on('change',function(){
        ...
        $.ajax({
            url:"{{ route('en.profile.product.quantity.main.filter.category', [Auth::user()->username_tag]) }}",
            method:"POST",
    ...
    $('.main-products-result').on('click', '.remove-main-product', function(){
        ...
        $.ajax({
            url:"{{ route('en.profile.product.quantity.main.all', [Auth::user()->username_tag]) }}",
            method:"POST",
    ...
    $( '.show-all-selected-main-products' ).on('click',function(){
        ...
        $.ajax({
            url:"{{ route('en.profile.product.quantity.main.selected', [Auth::user()->username_tag]) }}",
            method:"POST",
    ...
    $( "select[name='sub_product_category']" ).on('change',function(){
        ...
        $.ajax({
            url:"{{ route('en.profile.product.quantity.sub.filter.category', [Auth::user()->username_tag]) }}",
            method:"POST",
    ...
    $( '.show-all-selected-sub-products' ).on('click',function(){
        ...
        $.ajax({
            url:"{{ route('en.profile.product.quantity.sub.selected', [Auth::user()->username_tag]) }}",
            method:"POST",
    ...
    $( '.show-all-sub-products' ).on('click',function(){
        ...
        $.ajax({
            url:"{{ route('en.profile.product.quantity.sub.all', [Auth::user()->username_tag]) }}",
            method:"POST",
            data:{_token: CSRF_TOKEN, sub_product_ids:sub_product_ids, sub_product_quantities:sub_product_quantities},
            dataType:'JSON',
            beforeSend: function(){
