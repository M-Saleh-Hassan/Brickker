                    ...
                    <div class="col-xs-12 ">
                        <nav>
                            <ul class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                <li class="active"><a data-toggle="tab" href="#offers">Pending Offers</a></li>
                                <li><a data-toggle="tab" href="#accepted">Accepted Offers</a></li>
                                <li><a data-toggle="tab" href="#rejected">Rejected Offers</a></li>
                            </ul>
                        </nav>
...
@section('custom-js')
    ...
    $('#accepted').on('click', '.deliver-offer', function(){
        if(confirm('Update status for this product ?'))
        {
            ...
            $.ajax({
                url:"{{ route('en.offer.provider.deliver') }}",
                method:"POST",
